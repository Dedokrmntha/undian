				...
				<tbody>
                    ...
                    foreach ($hasil->result_array() as $y) : ?>
						<tr>
                            ...
                            <td> <a onclick="return confirm ('Yakin hapus <?php echo $y['id_user'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Data" href="<?php echo site_url().'Admin/delete' ?>/<?php echo $y['id_user']; ?>"><span class="glyphicon glyphicon-trash"></a>   
                                <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Edit Data" href="<?php echo site_url().'Admin/editpm' ?>/<?php echo $y['id_user']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
                       </td> 
						</tr>
					<?php endforeach; ?>
				</tbody>
