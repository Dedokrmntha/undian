...
<body>
<center><h1>DOORPRIZE </h1></center>
<center><h1>ANGKASA PURA I </h1></center>
<center><img src="<?php echo config_item('base_url') ?>/assets/3.gif" height="80" width="700"/></center> 
 ...
 <!-- <center><a a href="<?php echo site_url().'Input/showdata' ?>" class="btn btn-sm btn-primary">Undi </a>  &nbsp&nbsp -->
              <center><a href="<?php echo site_url().'Input/stop' ?>" class="btn btn-sm btn-danger" style="font-size: 20px;">Stop </a> 
